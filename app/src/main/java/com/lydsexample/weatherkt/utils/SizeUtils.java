...
public final class SizeUtils {
    ...
    public static void setDialogWidth(Context mAct, Dialog dialog , float width){
        WindowManager windowManager = ((Activity) mAct).getWindowManager();
        Display display = windowManager.getDefaultDisplay();
        WindowManager.LayoutParams lp = dialog.getWindow().getAttributes();
        lp.width = (int)(Math.min(display.getWidth(),display.getHeight())*width); //设置宽度
